...
import TraceTestPages from "./OtherPages/TraceTestPages";
        ...
        <Grid container spacing={4} justifyContent="center" alignItems="stretch" sx={{ mt: { xs: 0, md: -8 } }}>
          ...
          <Grid>
            <MenuCard
             ...
             items={[
                { head: "SOS 올리GO당 [멘토]", detail: "2024.09~2024.11 전공 자바프로그래밍 멘토" },
          ...
          <Grid>
            <MenuCard
              ...
              items={[
                { head: "창업아이디어톤 경진대회 우수상 [팀장]", detail: "2025.11.22 조선대학교" },
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <Routes>
        ...
        <Route path="/TRACETEST" element={<TraceTestPages />} />
