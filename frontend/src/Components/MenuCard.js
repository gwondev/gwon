        ...
        <Stack spacing={0.9} alignItems="center" textAlign= "center">
          {items.slice(0, 6).map((it, i) => (
            <Stack key={i} direction="row" textAlign= "center" alignItems ="center" >
              <Typography variant="body1" sx={{fontSize: 12,  fontWeight: 500, lineHeight:1, ...wrap }}>
                {it.head}
              </Typography>
              ...
              <Typography variant="caption" sx={{fontSize: 7,  color: "text.secondary", ...wrap }}>
                {it.detail}
              </Typography>
            </Stack>
          ))}
